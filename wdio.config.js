const dynamicConfig = {};
    ...
    dynamicConfig.baseUrl = 'https://geo-quiz.xyz';
...
exports.config = Object.assign({}, {
    ...
    //
    specs: [
        // When in maintenance mode, the regular checks will obviously fail, so only run the maintenance mode one
        './__e2e__/**.spec.js',
    ],
    // Patterns to exclude.
    exclude: [
    ...
    screenshotPath: './__e2e__/errorShots/',
    //
